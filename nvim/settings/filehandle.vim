...
" Assembly Code Config
"autocmd Filetype asm setlocal ft=nasm
"autocmd Filetype asm setlocal ft=fasm
autocmd Filetype asm setlocal ft=gas
autocmd BufNewFile,BufRead *.clangd setlocal ft=yaml
autocmd BufNewFile,BufRead *.lds setlocal ft=ld
"autocmd Filetype asm source $homie\plug-config\nasm.vim
...
autocmd FileType java,python nnoremap <buffer> ti :call CocAction('format')<cr>
